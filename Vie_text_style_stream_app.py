...
st.markdown("<h1 style='text-align: center; font-size:20px'>VIETNAM NATIONAL UNIVERSITY, HO CHI MINH CITY</h1>", unsafe_allow_html=True)
st.markdown("<h1 style='text-align: center;font-size:20px'>UNIVERSITY OF SCIENCE</h1>", unsafe_allow_html=True)
...
st.markdown("<h1 style='text-align: center;font-size:30px'>Vietnamese Text Style Classification Tool</h1>", unsafe_allow_html=True)
